...
const copy = {
  ...
  ja: {
    scenarioLabel: '業務シナリオ',
    scenarioTitle: '成長を決める業務シナリオに合わせたソリューション。',
    scenarioBody: 'NovaStudio はコンテンツ、キャンペーン、AI 検索露出、リード獲得、顧客運用を AI ネイティブなワークフローに接続します。',
    learn: '詳しく見る',
    ...
    stackLabel: 'NovaOS レイヤー',
    stackTitle: '未来の AI Marketing OS をスクロールで体験。',
    stackBody: 'スクロールすると既読モジュールが折りたたまれ、現在のモジュールが展開されます。',
    ...
    resourcesTitle: 'AI マーケティングチーム向けリソース。',
    resources: [['業界知見', 'AI 検索が発見を変える'], ['製品ツール', 'Brief、カレンダー、LP チェックリスト'], ['成長手册', 'Web3、Fintech、SaaS、SME']],
    casesTitle: '構築できるシステム例。',
    cases: [['Fintech 獲得', '教育コンテンツと LP。'], ['Web3 オンボーディング', '登録案内と KYC 教育。'], ['AI SaaS 権威エンジン', '説明、比較、GEO 記事。']],
    faqTitle: 'よくある質問。',
    faqs: [['NovaStudio は？', 'AI マーケティングワークフローを構築します。'], ['NovaOS は？', '将来の AI Marketing OS です。'], ['CRM と接続できますか？', '将来の接続接口を予約しています。'], ['向いている会社は？', 'Fintech、Web3、AI SaaS、中小企業など。']],
  },
  ko: {
    scenarioLabel: '비즈니스 시나리오',
    scenarioTitle: '성장을 결정하는 시나리오를 위한 솔루션.',
    scenarioBody: 'NovaStudio는 콘텐츠, 캠페인, AI 검색 노출, 리드 확보, 고객 운영을 하나의 AI 네이티브 워크플로로 연결합니다.',
    learn: '더 알아보기',
    ...
    stackLabel: 'NovaOS 플랫폼 레이어',
    stackTitle: '스크롤로 경험하는 미래 AI Marketing OS.',
    stackBody: '스크롤하면 지난 모듈은 접히고 현재 모듈은 펼쳐집니다.',
    ...
    resourcesTitle: 'AI 마케팅 팀을 위한 리소스.',
    resources: [['산업 인사이트', 'AI 검색이 발견을 바꾸는 방식'], ['제품 도구', 'Brief, 캘린더, LP 체크리스트'], ['성장 플레이북', 'Web3, 핀테크, SaaS, SME']],
    casesTitle: '구축 가능한 시스템 예시.',
    cases: [['핀테크 획득', '교육 콘텐츠와 랜딩 자산.'], ['Web3 온보딩', '가입 안내와 KYC 교육.'], ['AI SaaS 권위 엔진', '설명, 비교, GEO 글.']],
    faqTitle: '자주 묻는 질문.',
    faqs: [['NovaStudio는?', 'AI 마케팅 워크플로를 구축합니다.'], ['NovaOS는?', '미래의 AI Marketing OS입니다.'], ['CRM과 연결되나요?', '향후 연결 인터페이스가 예약되어 있습니다.'], ['어떤 회사에 적합한가요?', '핀테크, Web3, AI SaaS, 중소기업 등에 적합합니다.']],
  },
} as const;
