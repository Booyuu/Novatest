...
const strengthCopy = {
  en: {
    ...
    matrixBody: 'Different industries need different acquisition language, trust signals, landing-page structure and customer journeys. NovaStudio can customize the same AI operating foundation for different markets.',
  ...
  zh: {
    ...
    matrixBody: '不同行业需要不同的获客语言、信任机制、落地页结构和客户路径。NovaStudio 可以基于同一套 AI 营销底层能力，为不同市场定制增长系统。',
